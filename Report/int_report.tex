...
\begin{document}
    ...
    \begin{enumerate}
        ...
        Each image was then taken and cropped into a square as this would standardize each image that will be fed into the neural net. We cropped images to sizes: $50\times 50$, $100\times 100$, and $244\times 244$ as seen below.
    \end{enumerate}

    \begin{figure}[t]
        \centering
        \subfigure[text]{
        \includegraphics[width=.225\textwidth]{pictures/CM1.jpg}
        }
        \subfigure[text]{
        \includegraphics[width=.225\textwidth]{pictures/HC4.jpg}
        }
        
        \subfigure[text]{
        \includegraphics[width=.225\textwidth]{pictures/HS2.jpg}
        }
