...
\textit{\huge A Deep Learning Model 
to Identifying Bird Species from Images}}
\author{\Large Ali Hamza\\ ah05084
  \and
...
\maketitle
\begin{center}
    {\huge Organization: World Wildlife Fund Pakistan}
    \begin{figure}[h!]
    \centering
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=5cm]{./pictures/Hulogo.png}
    \label{fig:example}%
\end{figure}
\end{center}
...
\begin{tabular}{|l|l|l|l|}
  ...
  2 & Worked on Final Report & 6.5 & 04302 \\ \hline
...
\subsection{Resources}
  ...
  \noindent All items produced during this Khidmat can be found here: \url{https://drive.google.com/drive/folders/1jGJuFPEnX3sYZSnK-uAY0uFQmqXfPbMt?usp=sharing}. This link includes the Google Colab notebook, all images collected, datasets developed, and the final report
  
  \noindent The entire code produced for this Khidmat can be found here: \url{https://drive.google.com/file/d/1tyvXu43z1UZdEPKRSyFogyMqaGNBvc5N/view?usp=sharing}. 
  
  
  \noindent It is recommended that the code be tested and run in a Google Colab environment due to the use of TPUs that allow for the neural net to train at quite a high speed. 
