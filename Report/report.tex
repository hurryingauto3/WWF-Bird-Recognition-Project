...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=7cm]{Report/pictures/Hulogo.png} }}%
    \qquad
    \subfloat{{\includegraphics[width=5cm]{Report/pictures/wwflogo.png} }}%
...
\subsection{Overview of CS Techniques Used}
 ...
 \begin{center}
      \begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=5cm]{Report/pictures/Acc_finalmodel.png}}}%
    \qquad
    \subfloat{{\includegraphics[width=5cm]{Report/pictures/loss_finalmodel.png} }}%
   % \caption{2 Figures side by side}%
    \label{fig:example}%
\end{figure}
\end{center}
